...
from . import atom_tests.data_test
from . import atom_tests.http_core_test
from . import atom_tests.auth_test
from . import atom_tests.mock_http_core_test
from . import atom_tests.client_test
from . import gdata_tests.client_test
from . import gdata_tests.core_test
from . import gdata_tests.data_test
from . import gdata_tests.data_smoke_test
from . import gdata_tests.client_smoke_test
from . import gdata_tests.live_client_test
from . import gdata_tests.gauth_test
from . import gdata_tests.blogger.data_test
from . import gdata_tests.blogger.live_client_test
from . import gdata_tests.spreadsheets.data_test
from . import gdata_tests.spreadsheets.live_client_test
from . import gdata_tests.projecthosting.data_test
from . import gdata_tests.projecthosting.live_client_test
from . import gdata_tests.sites.data_test
from . import gdata_tests.sites.live_client_test
from . import gdata_tests.analytics.data_test
from . import gdata_tests.analytics.live_client_test
from . import gdata_tests.contacts.live_client_test
from . import gdata_tests.contacts.profiles.live_client_test
from . import gdata_tests.calendar_resource.live_client_test
from . import gdata_tests.calendar_resource.data_test
from . import gdata_tests.apps.emailsettings.data_test
from . import gdata_tests.apps.emailsettings.live_client_test
from . import gdata_tests.apps.multidomain.data_test
from . import gdata_tests.apps.multidomain.live_client_test
